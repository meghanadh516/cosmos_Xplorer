...
class _AIAssistantScreenState extends State<AIAssistantScreen>
  ...
  Future<void> _sendMessage(String text) async {
    ...
    try {
      ...
      } else if (response.statusCode == 400 && response.body.contains('credit')) {
        setState(() {
        _messages.add(
  _Message(
    text:
        "⭐ NOVA needs credits to answer!\n"
        "Please add credits at console.anthropic.com/billing.\n\n"
        "Meanwhile, here is what I know:\n"
        "The universe is 13.8 billion years old, contains about 2 trillion galaxies, and is still expanding! 🌌",
    isUser: false,
  ),
); 
    _isLoading = false;
