                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      FadeInLeft(delay: Duration(milliseconds: 600), child: _LevelCard("Black Holes", "Where gravity breaks reality", Color(0xFF80CBC4), () => Navigator.push(context, _route(GalaxyScreen())))),
          ...
          SafeArea(
            child: Column(
              ...
              children: [
                ...
                Padding(padding: const EdgeInsets.fromLTRB(20, 0, 20, 16), child: Text("8 worlds — tap to uncover their secrets", style: GoogleFonts.rajdhani(fontSize: 13, color: Colors.white38))),
                Expanded(
            ...
            Expanded(
              child: Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  Row(children: [
                    Expanded(child: Text(planet.name, style: GoogleFonts.orbitron(fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 1))),
...
with open("lib/screens/home_screen.dart", "w") as f:
    f.write(home)
with open("lib/screens/planets_screen.dart", "w") as f:
    f.write(planets)

print("home_screen:", len(home.splitlines()), "lines")
print("planets_screen:", len(planets.splitlines()), "lines")
