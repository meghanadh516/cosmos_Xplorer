          ...
          SafeArea(
            child: Column(
              children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: RadialGradient(colors: [Color(0xFF1A6FBF), Color(0xFF0A3F7F), Color(0xFF051A3F)], stops: [0.3, 0.7, 1.0],
                ...
                // Search bar
                FadeInDown(delay: Duration(milliseconds: 300), child: Padding(
                ...
                const SizedBox(height: 10),
                // Daily Fact
                FadeInUp(delay: Duration(milliseconds: 350), child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16),
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      FadeInUp(delay: Duration(milliseconds: 400), child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(borderRadius: BorderRadius.circular(20), child: Stack(fit: StackFit.expand, children: [
                            ...
                            Positioned(top: 12, right: 12, child: Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5), decoration: BoxDecoration(color: Colors.black38, borderRadius: BorderRadius.circular(20), border: Border.all(color: Colors.white24)), child: Text("FEATURED", style: GoogleFonts.orbitron(fontSize: 7, color: Colors.white70, letterSpacing: 2)))),
                          ])),
                        ),
                      )),
                      // Image cards
                      ...[
                        ...
                        ["Universe", "93 billion light years of space", "assets/images/universe.jpg", Color(0xFF90CAF9), UniverseScreen()],
                        ["Multiverse", "Beyond our universe", "assets/images/multiverse.jpg", Color(0xFFF48FB1), MultiverseScreen()],
                      ].asMap().entries.map((e) {
                        final i = e.key;
                        final d = e.value;
                        return FadeInLeft(
                          delay: Duration(milliseconds: 450 + i * 80),
                          child: GestureDetector(
                      ...
                      // Quiz card
                      FadeInLeft(delay: Duration(milliseconds: 850), child: GestureDetector(
